						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
									<a href="{{url('/add_invoice_view')}}" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
											...
											<a href="{{url('/export_invoices')}}" class="modal-effect btn btn-sm btn-success" style="color:white"><i
									...
									<table id="example1" class="table key-buttons text-md-nowrap">
										...
										<?php $i=0 ?>
											...
											<tr>
												...
												<td>
													<a onclick="return confirm('Are You Sure To Restore This')" class="btn btn-primary" href="{{url('/restore_invoice' , $invoice->id)}}">Restore</a>
												</td>
												<td>
													<a class="btn btn-dark" href="{{url('/change_payment_status_view' , $invoice->id)}}">Change Payment Stauts</a>
												</td>
												<td>
													<a onclick="return confirm('Are You Sure To Archive This')" class="btn btn-success" href="{{route('SoftDelete' , $invoice->id)}}">Archive</a>
												</td>
											</tr>
											@endforeach
										</tbody>

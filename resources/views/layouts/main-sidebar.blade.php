...
<aside class="app-sidebar sidebar-scroll">
	<div class="main-sidebar-header active">
		<a class="desktop-logo logo-light active" href="{{ url('/' . $page='login') }}"><img src="{{URL::asset('assets/img/brand/logo.png')}}" class="main-logo" alt="logo"></a>
		...
		<ul class="side-menu">
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					...
					<li><a class="slide-item" href="{{ url('/clients_report') }}">تقارير العملاء</a></li>
				</ul>
			</li>

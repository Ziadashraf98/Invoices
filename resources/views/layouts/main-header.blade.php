				...
				<div class="dropdown nav-item main-header-notification">
					...
					<div class="dropdown-menu">
						<div class="menu-header-content bg-primary text-right">
							...
							<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">عدد الاشعارات الغير مقروؤة : {{Auth::user()->unreadNotifications->count()}}</p>
						</div>
						<div class="main-notification-list Notification-scroll">
							@foreach(Auth::user()->unreadNotifications as $notification)
							<a class="d-flex p-3 border-bottom" href="{{$notification->data['link']}}">
								...
								<div class="mr-3">
									...
									<div class="notification-subtext">{{date('d/m/y | h:i A', strtotime($notification->created_at))}}</div>
								</div>
								<div class="mr-auto" >
